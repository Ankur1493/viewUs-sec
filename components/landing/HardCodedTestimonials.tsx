...
const testimonials = [
  ...
  },
  {
    item: 3,
    content:
      "project mayhem but it didn't work. I don't know why. I'm not a developer. I'm a salesman. I sell soap. Also this platform is hella expensive.",
    author: "Tyler Durden",
                ...
                {column.concat(column).map((testimonial, index) => (
                  <div
                    ...
                    className={cn(
                      ...
                      testimonial.item % 2 === 0
                        ? "bg-gray-950 shadow-gray-500"
                        : ""
                    )}
                  >
                        ...
                        <div className="ml-3">
                          <p
                            className={cn(
                              ...
                              testimonial.item % 2 === 0 ? "text-gray-50" : ""
                            )}
                          >
                            {testimonial.author}
                          </p>
