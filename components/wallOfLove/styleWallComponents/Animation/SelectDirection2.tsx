...
export const SelectDirection2 = () => {
  ...
  const handleThemeChange = (newTheme: string) => {
    ...
    if (url) {
      ...
      testUrl.searchParams.set("direction2", newTheme);
  ...
  return (
    <WallSidebarWrapper
      header="Animation Direction 2"
      description="Select a direction for your another row"
    >
